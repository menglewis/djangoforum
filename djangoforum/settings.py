...
DATABASES = {
    'default': {
        ...
        'NAME': path.join(DJANGO_ROOT, 'forum.db'),                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = path.join(DJANGO_ROOT, 'media')
...
SECRET_KEY = 'sb24^v640ouh)gplvixle2b+clc)s17y=zimrvl!_@&amp;0k2s0mj'
